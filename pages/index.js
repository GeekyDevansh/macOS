    ...
    <>
     <Head>
      ...
      <div className="bg-[url('/wallpaper.jpg')] h-screen w-screen bg-cover bg-no-repeat relative overflow-x-hidden ">
        ...
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="18" width="18" xmlns="http://www.w3.org/2000/svg" className="mt-0.5 h-5 mt-1 w-5 ml-4"><path d="M747.4 535.7c-.4-68.2 30.5-119.6 92.9-157.5-34.9-50-87.7-77.5-157.3-82.8-65.9-5.2-138 38.4-164.4 38.4-27.9 0-91.7-36.6-141.9-36.6C273.1 298.8 163 379.8 163 544.6c0 48.7 8.9 99 26.7 150.8 23.8 68.2 109.6 235.3 199.1 232.6 46.8-1.1 79.9-33.2 140.8-33.2 59.1 0 89.7 33.2 141.9 33.2 90.3-1.3 167.9-153.2 190.5-221.6-121.1-57.1-114.6-167.2-114.6-170.7zm-105.1-305c50.7-60.2 46.1-115 44.6-134.7-44.8 2.6-96.6 30.5-126.1 64.8-32.5 36.8-51.6 82.3-47.5 133.6 48.4 3.7 92.6-21.2 129-63.7z"></path></svg>
      <div>

      <ul className="list-none flex " >
        <li className="ml-5 font-extrabold pt-0.5 capitalize "  >
          {p}
          </li>
        <li className="ml-5 font-semibold my-0.5  hidden md:block " >File</li>
        <li className="ml-5 font-semibold  my-0.5 hidden md:block "  >Edit</li>
        <li className="ml-5 font-semibold my-0.5  hidden md:block "  >View</li>
        <li className="ml-5 font-semibold  my-0.5 hidden md:block "  >Go</li>
        <li className="ml-5 font-semibold  my-0.5 hidden md:block "  >Window</li>
        <li className="ml-5 font-semibold my-0.5  hidden md:block "  >Help</li>
      </ul>
      </div>

        </div>
        <div className="font-semibold mr-2 text-md flex my-0.5 " >
          <div>
